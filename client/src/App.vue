...
:root {
  ...
  --color-ink: #1a1a1a;
  --color-ink-secondary: oklch(0.45 0.02 260);
  --color-ink-tertiary: oklch(0.6 0.01 260);
  --color-muted: oklch(0.85 0.01 260);
  ...
  --shadow-lg: 0 8px 24px oklch(0.2 0 0 / 0.1);
