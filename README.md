...
- 📚 **讲义管理** — 上传 ZIP/HTML 讲义，自动解析章节、提取目录、支持封面与分类
- 👥 **权限分级** — 公开精选 + 班级×分类权限混合模型，精细控制访问范围
- 📖 **在线学习** — 章节导航、目录定位、阅读进度跟踪、最近学习记录
- 🗂️ **知识库** — 整合飞书文档链接，支持 Markdown/PDF 在线预览
...
1. 设置 `NODE_ENV=production` 和强随机 `JWT_SECRET`
